...
class TbSquare {
    ...
    fun testGetName(){
        /* create a square */
        val square : Shape = Square(SQUARE_NAME)
        /* check the name */
    ...
    @Test
    fun testDimensions2(){
        val square : Square = Square(SQUARE_NAME)
...
const val SQUARE1_DIMENSIONS = "length = 1.0000e+1, height = 1.0000e+1"
 ...
 * dimensions */
const val SQUARE2_DIMENSIONS = "length = 8.0000e+0, height = 1.2000e+1"
